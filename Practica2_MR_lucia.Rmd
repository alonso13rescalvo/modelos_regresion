...
El p-valor indica  si la función suavizada para este predictor es significativa. Tenemos que el p-valor < 2e-16. Como p-valor < 0.05, la relación entre el predictor y la variable dependiente es estadísticamente significativa. Esto tiene sentido ya que 'Total Interactions' es la suma de like, share y comment.
...
En cuanto al p-valor, tenemos que el p-valor < 2e-16. Como p-valor < 0.05, la relación entre el predictor y la variable dependiente es estadísticamente significativa, en este caso entre 'Total interactions' y 'Lifetime Post reach by people who like your Page'
...
```{r}
# Verificar la deviance explicada y el AIC
cat("Deviance Explicada:", summary(modelo_gam2)$dev.expl, "\n")
