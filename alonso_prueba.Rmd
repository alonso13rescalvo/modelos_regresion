...
plot(log(train$`Page total likes`, train$`Total Interactions`), main="Relación entre Variable y Target",
     xlab="Variable", ylab="Target", col="blue", pch=16)
modelo <- lm(train$`Total Interactions` ~ train$`Page total likes`, data=train)
summary(modelo)
...
plot(train$`Lifetime Post reach by people who like your Page`, train$`Total Interactions`, main="`Lifetime Post reach by people who like your Page` vs Total Interactions",
     xlab="`Lifetime Post reach by people who like your Page`", ylab="Total Interactions", col="red", pch=16)
